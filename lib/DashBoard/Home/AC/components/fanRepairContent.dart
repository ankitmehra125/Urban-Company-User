...
Widget fanRepairContent(BuildContext context)
{
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.fill,
                            image: AssetImage("assets/images/dashboard_images/home_images/fanRepair.jpg"))
                    ),
                    child: Column(
                      children: [
                            ...
                            children: [
                              Column(
                                children: [
                                  ClipRRect(
                                      ...
                                      child: Image.asset("assets/images/dashboard_images/home_images/fanService.jpg",
                              ...
                              Column(
                                children: [
                                  ClipRRect(
                                      borderRadius : BorderRadius.circular(12),
                                      child: Image.asset("assets/images/dashboard_images/home_images/condenserRapair.jpg",
                                        width: mQuery.size.width*0.23,)),
                                  SizedBox(height: mQuery.size.height*0.01,),
                                  Text("Condenser repair",style: TextStyle(
                                      color: Color(0xff222222),
                                      fontFamily: 'SatoshiMedium',
                                      fontSize: 10
                                  ),),
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.fill,
                                            image: AssetImage("assets/images/dashboard_images/home_images/installing.jpg")
                                        )
                                    ),
                                  ),
                                  // Image.asset("assets/images/dashboard_images/home_images/installing.jpg"),
                                  SizedBox(height: mQuery.size.height*0.01,),
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.fill,
                                            image: AssetImage("assets/images/dashboard_images/home_images/other.jpg")
                                        )
                                    ),
                                  ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text("Price includes labor charges foe 1"
                                          "\nFan Installation (15+ amp)",style: TextStyle(
                                          fontSize: 13,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: mQuery.size.height * 0.016),
                                    Text("Thorough cleaning to remove dust and"
                                        "\nimprove fan efficiency",style: TextStyle(
                                        fontSize: 13,
                                        color: Color(0xff4B4B4B),
                                        fontFamily: 'SatoshiMedium'
                                    ),)
