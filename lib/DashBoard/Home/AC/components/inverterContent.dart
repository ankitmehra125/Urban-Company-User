...
Widget inverterContent(BuildContext context)
{
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.fill,
                            image: AssetImage("assets/images/dashboard_images/home_images/invterImage.png"))
                    ),
                    child: Column(
                      children: [
                            ...
                            children: [
                              Column(
                                children: [
                                  ClipRRect(
                                      ...
                                      child: Image.asset("assets/images/dashboard_images/home_images/wiringService.jpg",
                              ...
                              Column(
                                children: [
                                  ClipRRect(
                                      borderRadius : BorderRadius.circular(12),
                                      child: Image.asset("assets/images/dashboard_images/home_images/wiring3.jpg",
                                        width: mQuery.size.width*0.23,)),
                                  SizedBox(height: mQuery.size.height*0.01,),
                                  Text("Wire repair",style: TextStyle(
                                      color: Color(0xff222222),
                                      fontFamily: 'SatoshiMedium',
                                      fontSize: 10
                                  ),),
                                ...
                                children: [
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        image: DecorationImage(
                                            fit: BoxFit.fill,
                                            image: AssetImage("assets/images/dashboard_images/home_images/wiring4.jpg")
                                        )
                                    ),
                                  ),
                                ...
                                children: [
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      SizedBox(height: mQuery.size.height * 0.023),
                                      Text("Stabilizers ensure a steady "
                                          "\nvoltage supply to electrical \n"
                                          "appliances despite \nfluctuations "
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(height: mQuery.size.height * 0.016),
                                    Text("Expert diagnosis and resolution \nof "
                                        "electrical wiring issues.",style: TextStyle(
                                        fontSize: 13,
                                        color: Color(0xff4B4B4B),
                                        fontFamily: 'SatoshiMedium'
                                    ),)
