...
Widget refrigeratorRepairContent(BuildContext context)
{
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.fill,
                            image: AssetImage("assets/images/dashboard_images/home_images/refrigeratorRepairImage.jpg"))
                    ),
                    child: Column(
                      children: [
                            ...
                            children: [
                              Column(
                                children: [
                                  ClipRRect(
                                      ...
                                      child: Image.asset("assets/images/dashboard_images/home_images/service.jpg",width: mQuery.size.width*0.23,)),
                              ...
                              Column(
                                children: [
                                  ClipRRect(
                                      borderRadius : BorderRadius.circular(12),
                                      child: Image.asset("assets/images/dashboard_images/home_images/rrFill.jpg",
                                        width: mQuery.size.width*0.23,)),
                                  SizedBox(height: mQuery.size.height*0.01,),
                                  Text("Repair & gas",style: TextStyle(
                                      color: Color(0xff222222),
                                      fontFamily: 'SatoshiMedium',
                                      fontSize: 10
                                  ),),
