...
Widget wiringContent(BuildContext context)
{
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            fit: BoxFit.fill,
                            image: AssetImage("assets/images/dashboard_images/home_images/wiring1.jpg"))
                    ),
                    child: Column(
                      children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  Column(
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text("Electrical Panel Inspection",
                                        style: TextStyle(
                                            color: Colors.black,
                                            fontFamily: 'SatoshiBold',
                                            fontSize: 16),
