...
class BleachPage extends StatefulWidget {
  const BleachPage({super.key});

  @override
  State<BleachPage> createState() => _BleachPageState();
}

class _BleachPageState extends State<BleachPage> {
    ...
    'services': [
      {
        ...
        'price': 'Starts at ₹299',
        'description': 'Olivia bleach for bright & even skin\ntone. Not '
      ...
      },
      {
        ...
        'reviews': '10k Reviews',
        'price': '₹299',
        'description': 'RAAGA detan pack infused with \nmilk, honey,and fruit'
            ' extracts.',
      }
    ],
    'addButtonText': 'Add',
